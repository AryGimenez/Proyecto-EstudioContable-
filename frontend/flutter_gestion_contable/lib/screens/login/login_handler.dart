...
class LoginHandler extends StatefulWidget {
  ...
  State<LoginHandler> createState() =>
      _LoginHandlerState(); // Crea el estado asociado a este widget.
}
...
class _LoginHandlerState extends State<LoginHandler> {
      ...
      if (mounted) {
        ...
        if (result['success']) {
          ...
          Navigator.of(context).pushReplacement(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    const MainHandler()), // Construye la ruta a la pantalla principal.
          );
        } else {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            ...
            SnackBar(
              // Crea un widget SnackBar para mostrar el mensaje de error.
              content: Text(result['message'] ??
                  'Error de autenticación.'), // Muestra el mensaje de error devuelto por el backend o un mensaje predeterminado.
            ),
          );
        }
      }
  ...
  void _togglePasswordVisibility() {
    setState(() {
      // Actualiza el estado para cambiar la visibilidad de la contraseña.
      _isPasswordVisible =
          !_isPasswordVisible; // Cambia el valor de _isPasswordVisible a su opuesto.
    });
  }
  ...
  void _navigateToPasswordReset() {
    Navigator.of(context).push(
      ...
      MaterialPageRoute(
          builder: (context) =>
              const PasswordResetHandler()), // Construye la ruta a la pantalla de reseteo de contraseña.
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // Construye la estructura básica de la pantalla de login.
      body: Center(
        ...
        child: SingleChildScrollView(
          ...
          child: LoginForm( // Construye el formulario de login.
            ...
            userController:
                _userController, // Pasa el controlador para el campo de usuario.
            passwordController:
                _passwordController, // Pasa el controlador para el campo de contraseña.
            isPasswordVisible:
                _isPasswordVisible, // Pasa el estado de visibilidad de la contraseña.
            onPasswordVisibilityToggle:
                _togglePasswordVisibility, // Pasa el método para alternar la visibilidad de la contraseña.
            onSubmit:
                _submitForm, // El botón de "Iniciar sesión" llama a este método.
            onResetPassword:
                _navigateToPasswordReset, // El botón "Olvidaste..." llama a este método.
          ),
        ),
      ),
    );
  ...
  void dispose() {
    ...
    super
        .dispose(); // Llama al método dispose de la clase base para liberar recursos adicionales.
  }
}
